...
describe('👻 modify', () => {
  it('🥳 modify tree node should work fine', () => {
    const html = mount(
      <Form>
        <Form.Item
          name="rule"
...
describe('👻 onRemove', () => {
  it('🥳 returns of onRemove should be effectively', async () => {
